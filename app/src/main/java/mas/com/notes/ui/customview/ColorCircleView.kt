package mas.com.notes.ui.customview
...
class ColorCircleView @JvmOverloads constructor(
    ...
    @Dimension(unit = PX) var radius: Float = (defRadiusDp * resources.displayMetrics.density)
    ...
    @Dimension(unit = PX) var strokeWidth: Float = (defStrokeWidthDp * resources.displayMetrics.density)
        set(value) {
            field = value
    ...
    init {
        ...
        val defRadiusPx = (defRadiusDp * resources.displayMetrics.density).toFloat()
